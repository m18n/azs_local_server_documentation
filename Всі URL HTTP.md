...
3. **/main/settings/configuration** #get - це сторінка з налаштуванням видів палива, резеруарів, колонки. повертає файл **configuration.html**. Це [[Сторінка Налаштування]]
## API
